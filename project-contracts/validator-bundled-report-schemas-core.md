...
workcell:
  ...
  owns_paths:
    ...
    - tools/coad-validator/src/coad_validator/schema/reports/ledger-handoff-integrity-report.schema.json
    - tools/coad-validator/src/coad_validator/schema/reports/ledger-report.schema.json
    - tools/coad-validator/src/coad_validator/schema/reports/methodology-loop-report.schema.json

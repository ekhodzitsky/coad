...
def main() -> int:
    parser = argparse.ArgumentParser(description="Report COAD conformance profile status")
    parser.add_argument("path", nargs="?", default=".", help="Path containing COAD contracts and profile")
